...
def enter_email_info():
    ...
    sender_label = Label(email_notebook, text="Sender:")
    sender_label.grid(row=1, column=0)
    sender = Entry(email_notebook, )
    sender.grid(row=1, column=1)
    receiver_label = Label(email_notebook , text="Receiver:")
    receiver_label.grid(row=2, column=0)
    receiver = Entry(email_notebook ,)
    receiver.grid(row=2, column=1)
    password_label = Label(email_notebook, text="Password:")
    password_label.grid(row=3, column=0)
    password = Entry(email_notebook, )
    password.grid(row=3, column=1)
    subject_label = Label(email_notebook, text="Subject:")
    ...
    body_label.grid(row=5, column=0, ipady=3, ipadx=3)
